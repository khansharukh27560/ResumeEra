...
import "../css/home.css";
import step1 from "../image/step1.webp";
import step2 from "../image/step2.webp";
import step3 from "../image/step3.webp";
import changeCV_image from "../image/changeCV_image.webp";
import best_logo from "../image/best_logo.webp";
import bridal_image from '../image/bride_image-removebg.webp';

// Lazy loaded components
const CoverLetterCrousel = lazy(() => import('./CoverLetterCrousel'));
const Carousel = lazy(() => import('./Crousel'));
const CrouselTechnical = lazy(() => import('./CrouselTechnical'));
const FAQSection = lazy(() => import('./FAQSection'));
const ShadiCardCrousel = lazy(() => import('./ShadiCardCrousel'));


const Home = (prop) => {
  const { images, techImages, CoverImage, shadi_Card } = prop;
  ...
  "potentialAction": {
    ...
    "query-input": "required name=search_term_string"
      ...
      <div className="home-welcome" style={{ padding: "2rem", background: "linear-gradient(135deg, #f5f7fa, #e0e7ff)" }}>
        ...
        <p> Get started today and elevate your career journey!</p>
      ...
      <section className="carousel-section">
        <div className="previewheader"><h2 >Free Resume Format Crousel by ResumeEra.xyz</h2></div>
      ...
      <hr className="home-divider" style={{ border: "1px solid #e0e7ff", margin: "2rem 0" }} />
      <section className="carousel-section">
        <div className="previewheader"><h2 >Technical  Free Resume Format Crousel by ResumeEra.xyz</h2></div>
        <Suspense fallback={<div>Loading...</div>}>
          <CrouselTechnical techImages={techImages} />
        </Suspense>
        {/* <div class="curve"></div> */}
      </section>
      ...
      <div className="home-cover-letter" style={{ padding: "4rem 2rem", background: "#f5f7fa", borderRadius: "12px", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)" }}>
        ...
        <section className="carousel-section">
          <div className="previewheader"><h2 >Free Cover Letter Format Crousel by ResumeEra.xyz</h2></div>
          <Suspense fallback={<div>Loading...</div>}>
            <CoverLetterCrousel CoverImage={CoverImage} />
          </Suspense>

          {/* <div class="curve"></div> */}
        </section>

        <Link to="/cover_letter" className="cta-button" style={{ display: "block", margin: "2rem auto 0", padding: "12px 24px", background: "#2d6adf", color: "white", borderRadius: "8px", textDecoration: "none", fontWeight: "bold", fontSize: "1.1rem", textAlign: "center", transition: "background 0.3s" }}>
          Create Your Resume & Cover Letter Now
        </Link>
      </div>
      <div className="home-shaadi-biodata" style={{ padding: "4rem 2rem", background: "#f5f7fa", borderRadius: "12px", boxShadow: "0 4px 6px rgba(0, 0, 0, 0.1)" }}>
        <h2 style={{ color: "#2d6adf", fontSize: "1.8rem", marginBottom: "1rem", textAlign: "center" }}>
          Create a Beautiful Shaadi Biodata in Minutes with ResumeEra
        </h2>
        <p style={{ color: "#333", fontSize: "1.1rem", marginBottom: "2rem", textAlign: "center" }}>
          Looking to create the perfect matrimonial biodata? ResumeEra makes it easy! Choose from elegant templates tailored for Shaadi profiles, highlight your background, family details, and preferences — then download your biodata as a professional PDF. Fast, free, and fully customizable!
        </p>
        <div className="home-biodata-carousel">
          {/* You can insert carousel here showing biodata formats */}
        </div>
        <section className="carousel-section">
          <div className="previewheader">
            <h2>Free Shaadi Biodata Templates by ResumeEra.xyz</h2>
            <div class="heart-container" >
              <div class="heart">
                <img src={bridal_image} alt="Heart Image" />
              </div>
            </div>
          </div>
          <Suspense fallback={<div>Loading...</div>}>
            <ShadiCardCrousel shadi_Card={shadi_Card} />
          </Suspense>
          {/* <div class="curve"></div> */}
        </section>
        <Link
          to="/marriage-biodata-format"
          className="cta-button"
          style={{
            display: "block",
            margin: "2rem auto 0",
        ...
        >
          Create Your Shaadi Biodata Now
        </Link>
      </div>
      <Suspense fallback={<div>Loading...</div>}>
        <FAQSection />
