...
const NormalResume = lazy(() => import('./NormalResume'));
const TechnicalResumeImages = lazy(() => import('./TechResume/TechnicalResumeImages'));
const FresherResume = lazy(() => import('./FresherResume'));
const ShadiCard = lazy(() => import('./Shadi article/ShadiCard'));
const ReactResume = lazy(() => import('./TechResume/ReactResume'));
const GoogleAd = lazy(() => import('./adFolder/GoogleAd'))

const TemplatePage = (props) => {
  const { images, techImages, fresherResumeImage, shadi_Card, reactJsDevResume } = props;
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  console.log('NormalResume:-', [NormalResume].map((item)=>item.src))
  return (
    <div className="template-page-container">
      ...
      <section className="hero-banner">
        ...
        <small className="hero-description">
          Looking for the perfect resume template to kickstart your career? Our free resume templates
          for 2025 are designed to help you create a professional, eye-catching resume that stands out.
        </small>
        <small className="hero-description">
          Whether you’re a beginner, a tech enthusiast, or seeking a standard format, customize your
          template today and take the first step toward your dream job.
        </small>
      ...
      <Suspense fallback={<div>Loading...</div>}>
        <ReactResume reactJsDevResume={reactJsDevResume} />
      </Suspense>
