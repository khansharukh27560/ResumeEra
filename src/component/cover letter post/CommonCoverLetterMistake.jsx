...
const CoverLetterMapping = React.lazy(()=>import("../CoverLetterMapping"))
const ShareButtons = React.lazy(()=>import("../shareButton/ShareButtons"))
const RandomeArticleToBlogCareer = React.lazy(()=>import("../RandomeArticleToBlogCareer"))
const WelcomeNotes = React.lazy(()=>import("../WelcomeNotes"))
const GoogleAd = React.lazy(()=>import("../adFolder/GoogleAd"))
    ...
    <div>
      ...
      <article className="aboutResumeEra">
        <section>
          ...
          />
          </section><Suspense fallback={<div>Loading...</div>}><GoogleAd /></Suspense>
          <section>
...
<Suspense fallback={<div>Loading...</div>}>
  <CoverLetterMapping CoverImage={CoverImage} /></Suspense>
<section><Suspense fallback={<div>Loading...</div>}>
<GoogleAd /></Suspense></section><Suspense fallback={<div>Loading...</div>}><GoogleAd /></Suspense>
<section>
