...
import How_to_Make_a_Resume_2024 from "../../src/image/How to Make a Resume 2024.webp";
import Crafting_Modern_Resume from "../image/image_for_link/Crafting a Modern Resume.webp";
import Top_Resume_Templates_for_2024 from '../image/image_for_link/Top Resume Templates for 2024.webp'
import What_Employers_Look_for_in_a_Resume from '../image/image_for_link/What Employers Look for in a Resume.webp'
import How_to_Format_a_Resume_Correctly from '../image/image_for_link/How to Format a Resume Correctly.webp'
// import Improving_Your_Resume_with_Action_Verbs from '../image/image_for_link/Improving Your Resume with Action Verbs.webp'
import xyz_formula from '../image/image_for_link/XYZ Formula.webp'
import Resume_for_International_Jobs from '../image/image_for_link/Resume for International Jobs.webp'
import How_to_Showcase_Your_Education_in_a_Resume from '../image/image_for_link/Showcase Your Education in a Resume.webp'
import Crafting_Powerful_Cybersecurity_Resume from '../image/image_for_link/Crafting Powerful Cybersecurity Resume.webp'
import Tips_to_Get_Your_CV_Noticed from '../image/image_for_link/Tips to Get Your CV Noticed.webp'
import Difference_Between_CV_and_Resume from '../image/image_for_link/Difference Between CV and Resume.webp'
import freeResumeBuilders from '../image/image_for_link/freeResumeBuilders.jpeg.webp'
import ATS_Formatting_Mistakes from '../image/image_for_link/ATS Formatting Mistakes.webp'
import It_Cover_Letter from '../image/image_for_link/IT Cover Letter Tips.webp'
import Management_Cover_Letter_Example from '../image/image_for_link/Management Cover Letter Example.webp'
import Mechanical_Engineering_Cover_Letter from '../image/image_for_link/Mechanical Engineering Cover Letter Example.webp'
import action_verbs_resume_intro from '../image/image_for_link/action-verbs-resume-intro.webp'
import Administrative_Assistant_Cover_Letter from '../image/image_for_link/Administrative Assistant Cover Letter.webp'
import Lawyer_Cover_Letter_Example from '../image/image_for_link/Lawyer Cover Letter Example.webp'
import Resume_Formatting_Kya_Hai from '../image/image_for_link/Resume Formatting Kya Hai.webp'
...
import Resume_Formatting_Steps from '../image/image_for_link/Resume Formatting Tips for Entry-Level Jobs.webp'
import ATS_Friendly_Resume_Format_for_Beginners from '../image/image_for_link/ATS-Friendly Resume Format for Beginners.webp'
import Simple_Resume_Formatting_Best_Practices from '../image/image_for_link/Simple Resume Formatting Best Practices.webp'
import Fresher_Resume_Mistakes from '../image/image_for_link/Fresher Resume Mistakes.webp'
import College_Graduates_Perfect_Resumez_Formatting from '../image/image_for_link/College Graduates Perfect Resume Formatting.webp'
import Resume_Formatting_First_Time_Job_Seekers from '../image/image_for_link/Resume Formatting Tips for First-Time Job Seekers.webp'
import Fresher_Resume_Font_Aur_Layout from '../image/image_for_link/Fresher Resume Font Aur Layout.webp'
import Professional_Resume_Format_for_Experienced_Candidates from '../image/image_for_link/Professional Resume Format for Experienced Candidates.webp'
import Executive_Level_Resume_Formatting from '../image/image_for_link/Executive-Level Resume Formatting.webp'
import Career_Change_Resume_Formatting from '../image/image_for_link/Career Change ke Liye Resume Formatting Kaise Karein.webp'
...
import Highlight_Achievements_Resume_Formatting from '../image/image_for_link/Highlight Achievements Resume Formatting.webp'
import Multi_Page_Resume_Formatting from '../image/image_for_link/Multi-Page Resume Formatting.webp'
import Job_Description from '../image/image_for_link/How to Tailor Your Resume to Match the Job Description Perfectly.webp'
import Functional_vs_Chronological_Resume_Formatting from '../image/image_for_link/Functional vs Chronological Resume Formatting.webp'
import It_Profetional_image from '../image/image_for_link/IT Professionals Ke Liye Resume Formatting Tipss.webp'
import HealthCare_images from '../image/image_for_link/Healthcare Industry Ke Liye Resume Formatting Guide.webp'
import Creative_Designer from '../image/image_for_link/Creative and Designers Resume Formatting Tips.webp'
import Sales_Marketing from '../image/image_for_link/resume formatting for sales and marketing professionals.webp'
import teachers_Professors from '../image/image_for_link/Professional Resume Formatting for Teachers and Professors.webp'
import Resume_Formating_Engineering_Students from '../image/image_for_link/Resume Formatting Tips for Engineering Students.webp'
import resume_formate_freelancers_remote_workers from '../image/image_for_link/Resume Formatting for Freelancers and Remote Workers.webp'
import Government_Job_Applications from '../image/image_for_link/Ideal Resume Formatting Guide for Government Job Applications.webp'
import Hospitality_tourism from '../image/image_for_link/Resume Formatting Tips for Hospitality and Tourism Professionals.webp'
import Resume_Formatting_Real_Estate_Agents from '../image/image_for_link/Resume Formatting Tips for Real Estate Agents.webp'
import Free_Resume_Formatting_Tools_for_2025 from '../image/image_for_link/Best Free Resume Formatting Tools for 2024.webp'
import Resume_Writing_Tips_for_Remote_Jobs from '../image/image_for_link/Resume Writing Tips for Remote Jobs.webp'
import blank_page from '../image/image_for_link/blank page.webp'
import Infographic_Resume from '../image/image_for_link/Infographic Resume Formatting Tools_ A Creative Approach.webp'
import Resume_Formatting_Mistakes from '../image/image_for_link/20 Resume Formatting Mistakes You Should Avoid.webp'
import Resume_Formatting_Errors from '../image/image_for_link/Top 10 Resume Formatting Errors and How to Fix Them-2025.webp'
import ATS_Unfriendly_Formatting from '../image/image_for_link/ATS-Unfriendly Formatting.webp'
import Avoid_OvwerDesign_Resume from '../image/image_for_link/overDesign image.webp'
import Font_and_Size from '../image/image_for_link/Font and Size Selection Mistakes.webp'
import Reflect_Career_Breaks from '../image/image_for_link/Reflect Career Breaks.webp'
import Grammar_mistake from '../image/image_for_link/Grammar Mistakes.webp'
import common_layout_mistake from '../image/image_for_link/Common Layout Mistakes.webp'
import resum_Download_pdf from '../image/image_for_link/resume format PDF Download.webp'
import pdf_vs_word from '../image/image_for_link/PDF vs. Word.webp'
import Chronological_vs_functional from '../image/image_for_link/Chronological vs. Functional Resume.webp'
import Infographics_vs_traditional from '../image/image_for_link/infographic vs traditional resume.webp'
import online_vs_manual from '../image/image_for_link/Online Resume Builder vs Manual Resume.webp'
import onepage_vs_multipage from '../image/image_for_link/one page vs multi page resume.webp'
import modern_vs_tradinal from '../image/image_for_link/modern vs tradinal image.webp'
import ats_vs_creative from '../image/image_for_link/ats vs creative resume.webp'
import minimalistvsgraphics from '../image/image_for_link/minimalist vs graphics resume.webp'
import summaryvsobjective from '../image/image_for_link/Objective Statement Vs Summary Statement.webp'
import resumeformatintrend from '../image/image_for_link/2025 Resume Formatting Trends.webp'
import resumeformattingaidriver from '../image/motivational_image/resume formatting ai drivern.jpg'
import Presenting_Personal_Branding from '../image/image_for_link/Presenting Personal Branding.webp'
import Matches_Your_LinkedIn_Profile from '../image/image_for_link/Matches Your LinkedIn Profile.webp'
import modern_resume from '../image/image_for_link/thoko.webp'
import Data_Driven_Resume from '../image/image_for_link/Data-Driven Resume.webp'
import SocialMediaInfluencer from '../image/image_for_link/SocialMediaInfluencer.webp'
import CreateJobSpecificResume from '../image/image_for_link/Create Job-Specific Resume.webp'
import FreelancersPortfolioResumeFormatting from '../image/image_for_link/FreelancersPortfolio Resume Formatting.webp'
import RemoteResumeFormatting from '../image/image_for_link/Remote Resume Formatting.webp'
import PersonalizedResumeFormatting from '../image/image_for_link/Personalized Resume Formatting International.webp'
import ResumeFormatting from '../image/image_for_link/Resume Formatting Your Ultimate.webp'
import DownloadtheBestResumeFormatPDF from '../image/image_for_link/Download the Best Resume Format PDF.webp'
import topResumeFormatepdfforjob from '../image/image_for_link/Top Resume Format PDF for Job Seekers.webp'
import EffortlessResumeCreations from '../image/image_for_link/Effortless Resume Creation.webp'
import ResumeFormatepdf from '../image/image_for_link/Resume Format PDF Guides.webp'
import GetHiredFasters from "../image/image_for_link/Get Hired Faster.webp";
import rightResumeFormat from '../image/image_for_link/Right Resume Format PDF.webp'
import FreeResumeFormats from '../image/image_for_link/FreeResumeFormatPDF.webp'
import CreateYourDreamJob from '../image/image_for_link/Create Your Dream Job Resume.webp'
import StepbyStepResumeCreations from "../image/image_for_link/Step-by-Step Resume Creation.webp";
import FreeResumeFormate from '../image/image_for_link/Free Resume Format PDFs.webp'
import ACompleteGuide from '../image/image_for_link/A Complete Guide to Resume Format PDF.webp'
import DownloadProfessional from '../image/image_for_link/DownloadaProfessionalResumeFormatPDF.webp'
import ResumeGuides from '../image/image_for_link/Resume Format PDF Guides.webp'
import TheUltimateCollectionofResumeFormatPDF from '../image/image_for_link/The Ultimate Collection of Resume Format PDF.webp'
import MyTop10FreeResumeFormatPD from '../image/image_for_link/My Top 10 Free Resume Format PDF.webp'
import DownloadYourFreeResumeFormat from '../image/image_for_link/Download Your Free Resume Format.webp'
import FindtheRightResumeFormat from '../image/image_for_link/Find the Right Resume Format.webp'
import LookingforaResumeFormat from '../image/image_for_link/Looking for a Resume Format.webp'
import DownloadResumeFormatPDF from '../image/image_for_link/Download Resume Format PDF.webp'
import Bestresumeformat from '../image/image_for_link/Best Resume Format PDF for.webp'
import HowtoCreateaWinning from '../image/image_for_link/How to Create a Winning Resume Using.webp'
import easytouse from '../image/image_for_link/easy to use.webp'
import HighImpactResumes from '../image/image_for_link/High-Impact Resumes.webp'
import freeresumeformat from '../image/image_for_link/Free Resume Format PDF Templates.webp'
import HowtoCreateaStunning from '../image/image_for_link/How to Create a Stunning Resume.webp'
import CraftthePerfectResume from '../image/image_for_link/Craft the Perfect Resume.webp'
import freeresumeform from '../image/image_for_link/Free Resume Format PDF Templates.webp'
import resumeformate from '../image/image_for_link/Resume Format.webp'
import resumeformatpdf from '../image/image_for_link/Resume Format PDF Guides.webp'
import resumeformatting from '../image/image_for_link/Resume Formatting Kya Hai.webp'
import professionalresumeformat from '../image/image_for_link/Professional Resume Format PDF.webp'
import crafttheperfectresume from '../image/image_for_link/Craft the Perfect Resume pdf.webp'
import YourStepbyStepGuidetoaProfessional from '../image/image_for_link/Your Step-by-Step Guide to a Professional.webp'
import CreateresumeThatGets from '../image/image_for_link/Create a Resume That Gets Result.webp'
import TopResumeFormatPDFforJobSeeker from '../image/image_for_link/Top Resume Format PDF for Job Seeker.webp'
import Optimizeyourresume from '../image/image_for_link/Optimize Your Resume with the Best Resume.webp'
import gettherightresume from '../image/image_for_link/Get the Right Resume Format PDF.webp'
import TheBestResumeFormat from "../image/image_for_link/The Best Resume Format PDF.webp";
import Downloadthetop from '../image/image_for_link/Download Resume Format PDF.webp'
import FreeResumeFormat from "../image/image_for_link/Free Resume Format PDF for Freshers.webp";
import Theultimateresume from '../image/image_for_link/Free Resume Format PDF for Fresher.webp'
import HowtoPicktheRightResume from '../image/image_for_link/How to Pick the Right Resume Format.webp'
import GetHiredwiththeBestResume from '../image/image_for_link/Get Hired with the Best Resume.webp'
import FreeResumeFormatss from "../image/image_for_link/Free Resume Format PDF Templates.webp";
import TopResumeFormat from '../image/image_for_link/Top Resume Format PDF Downloads for a Perfect.webp'
import BestResumeFormat from '../image/image_for_link/Best Resume Format PDFfor.webp'
import ResumeFormatPDF from '../image/image_for_link/Resume Format PDF for Freshers.webp'
import SimpleYetProfessional from "../image/image_for_link/Simple Yet Professional Resume Format.webp";
import UnlockYourCareer from '../image/image_for_link/Unlock Your Career Potential.webp'
import FreeDownloadableResume from '../image/image_for_link/Free Downloadable Resume Format PDFs.webp'
import HowtoBuildanImpactful from '../image/image_for_link/How to Build an Impactful Resume.webp'
import ResumeFormatPDFs from '../image/image_for_link/Resume Format PDFs.webp'
import GetNoticedwith from "../image/image_for_link/Get Noticed with the Best Resume.webp";
import GetNoticed from '../image/image_for_link/Get Noticed with a Professional Resume Format PDF.webp'
import SimpleResumeFormatPDF from '../image/image_for_link/Format PDFJob Seekers 2025.webp'
import TheCompleteGuide  from '../image/image_for_link/The Complete Guide to Choosing.webp'
import PerfectforCareerSuccess from '../image/image_for_link/Perfect for Career Success.webp'
import GetYouenergy from '../image/image_for_link/Get You Energy in Interview.webp'
import ResumeMistakess from '../image/image_for_link/Resume Mistakes You Need to Avoid in-á2025.webp'
import JobApplications from '../image/image_for_link/Job Applications Resume Format PDF Download now  2025.webp'
import HowToUseResume from '../image/image_for_link/How to Use Resume Format PDFs 2025 Winning Job Application.webp'
import PerfectYourResume from '../image/image_for_link/Perfect Your Resume with the Best Resume Format PDFs.webp'
import BestResumeFormats from '../image/image_for_link/Best Resume Format PDF for Immediate Job Offers Copy.webp'
import FreeTopResume from '../image/image_for_link/free Top Resume Format PDF Successfull career -2025 Download now .webp'
import TopResumeFormatPDFforCareerSuc from '../image/image_for_link/free Top Resume Format PDF Successfull career -2025 Download now .webp'
import GetHiredSoon from '../image/image_for_link/Download Your Resume Format PDF Today Get Hired Soon.webp'
import BuildYourBestCV from '../image/image_for_link/Build Your Best CV Now.webp'
import FresherExpertProfessional from '../image/image_for_link/Get Free Resume Format Download Now Fresher & Expert Professional.webp'
import Howtooptimise from '../image/image_for_link/How to Optimize Your Killer Resume Format PDF in 2025.webp'
import Howtohandle from '../image/image_for_link/How to handle recruiters.webp'
import SimpleResumeFormatWord from '../image/technical_Image/Basic_Ats_Resume_Template.webp'
import pdfImage from '../image/technical_Image/Creative-ATS-Resume-Template.webp'
...
import pdfresumeformat from '../image/image_for_link/PDF Resume Format Free Download.webp'
  ...
  const posts = [
    {
      ...
      src: "https://resumeera.xyz/static/media/download.96cc600c1311eb5dce13.webp",
      alt: "ResumeEra logo",
    },
    {
      path: "/how-to-create-a-professional-resume",
      title: "How to Create a Professional Resume",
      src: "https://img.freepik.com/free-photo/handsome-young-man-working-laptop-smiling-while-sitting-sidewalk-cafe_231208-12079.webp",
    ...
    },
    {
      ...
      src: "https://img.freepik.com/free-photo/close-up-female-typing-laptop_23-2148889241.webp",
      alt: "tips for writing cover letter",
    },
    {
      path: "/why-soft-skills-matter",
      title: "Why Soft Skills Matter in Your Resume",
      src: "https://resumeera.xyz/static/media/soft_skill_image.99deb76d8f4fd0d357ae.webp",
    ...
    },
    {
      ...
      src: "https://img.freepik.com/free-photo/smiling-business-woman-working-laptop-office_23-2148880288.webp",
      alt: "Common resume mistakes",
    },
    {
      path: "/how-to-choose-the-right-resume-template",
      title: "How to Choose the Right Resume Template",
      src: "https://resumeera.xyz/static/media/choose_temp.050099d5e7367c2b7c47.webp",
    ...
    },
    {
      ...
      src: "https://resumeera.xyz/static/media/job_resume.9b3fb1d529d4360da89a.webp",
      alt: "Resume for first job",
    },
    {
      path: "/how-to-highlight-achievements-in-a-resume",
      title: "How to Highlight Achievements in a Resume",
      src: "https://resumeera.xyz/static/media/highlight_image.deb2ff56bdcf6a809071.webp",
    ...
    },
    {
      ...
      src: "https://resumeera.xyz/static/media/tip_for_interview.9109e4f006a1c28b0414.webp",
      alt: "Interview tips",
    },
    {
    ...
    },
    {
      ...
      src: "https://img.freepik.com/free-photo/close-up-hand-writing-laptop_23-2148902636.webp",
    ...
    },
    {
      ...
      src: "https://img.freepik.com/free-photo/woman-writing-resume_23-2148998403.webp",
    ...
    },
    {
      ...
      src: "https://img.freepik.com/free-photo/student-studying-laptop_23-2148998405.webp",
      alt: "Resume with no experience",
    },
    {
      path: "/how-to-write-a-resume-for-career-change",
      title: "How to Write a Resume for Career Change",
      src: "https://img.freepik.com/free-photo/female-working-resume-template_23-2148998412.webp",
    ...
    },
    {
      ...
      src: "https://img.freepik.com/free-photo/business-meeting-collaboration_23-2148899008.webp",
      alt: "Resume tips",
    },
    {
      path: "/xyz-resume",
      ...
      src:"https://i.postimg.cc/NGZ0P9FL/xyz-formula-image.webp",
      alt: "XYZ  resume",
    },
    {
      ...
      src: "https://img.freepik.com/free-photo/businessman-preparing-resume_23-2149050332.webp",
    ...
    },
    {
      ...
      src: "https://img.freepik.com/free-photo/human-resources-interview_23-2149050143.webp",
    ...
    },
    {
      ...
      src: "https://img.freepik.com/free-photo/actor-anupam-kher-speaking-microphone_23-2148998417.webp",
    ...
    },
    {
      ...
      src: "https://img.freepik.com/free-photo/man-using-laptop_23-2149011460.webp",
    ...
    },
    {
      ...
      src: "https://img.freepik.com/free-photo/student-using-free-resume-builder_23-2149122257.webp",
    ...
    },
    {
      ...
      src: 'https://img.freepik.com/free-vector/online-resume-concept-illustration_114360-5166.webp',
      alt: "resume pdf",
    },
    {
      path: "/resume-format-pdf-for-fresher",
      title: "Resume Format PDF for Freshers: Your Complete Guide to Crafting a Winning Resume",
      src: 'https://img.freepik.com/free-vector/profile-data-concept-illustration_114360-2770.webp',
      alt: "Resume Format PDF for Fresher",
    },
    {
      path: "/resume-pdf-download",
      title: "Resume PDF Download - How to Download Your Resume as a PDF",
      src: 'https://img.freepik.com/free-vector/online-cv-illustration-concept_23-2148566615.webp',
    ...
    },
    {
      ...
      src: 'https://img.freepik.com/free-vector/lettering-business-sticker-set_23-2150185946.webp',
      alt: "Resume Quotes",
    },
    {
      ...
      src: 'https://img.freepik.com/premium-vector/designer-creative-resume-template_23-2147540760.webp',
    ...
    },
    {
      ...
      src: 'https://img.freepik.com/free-vector/recruitment-concept-with-laptop_23-2148621834.webp',
    ...
    },
    {
      ...
      src: 'https://img.freepik.com/free-vector/illustrated-choice-worker-concept_52683-44355.webp',
    ...
    },
    {
      ...
      src: 'https://img.freepik.com/free-vector/online-cv-concept_23-2148555717.webp?t=st=1737619117~exp=1737622717~hmac=99f5c909b8d31a5decdb213fea7772d22dd998f43cd39e98ab65452e5826c3e2&w=740',
    ...
    },
    {
      ...
      src: 'https://img.freepik.com/free-vector/resume-writing-service-abstract-concept-illustration-copywriting-service-cv-online-professional-help-writing-resume-cover-letter-candidate-profile-career-summary_335657-143.webp',
    ...
    },
    {
      ...
      src: 'https://img.freepik.com/free-vector/flat-design-cooking-class-online-resume_23-2149934784.webp',
    ...
    },
    {
      ...
      src: 'https://img.freepik.com/free-vector/profile-data-concept-illustration_114360-28079.webp?t=st=1738414491~exp=1738418091~hmac=d918d399fdf07825813cebf8bdb5bfb93c8d560fe0137410f1537dc21774a2eb&w=740',
      alt: "functional resume format",
    },
    {
      path: "/resume-format-for-freshers",
      title: "Resume Format For Freshers:free and easy download now",
      src: 'https://img.freepik.com/free-vector/online-resume-concept-illustration_114360-8401.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/BQzpQJ4W/Resume-Format-for-Freshers-example.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/pL4GGcd5/type-of-resume-format-for-fresher.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/0Qc3h1nf/functional-resume.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/tCWTdwMM/1st-Job-Resume-Examples.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/xdWW9fvf/freepik-the-style-is-candid-image-photography-with-natural-52995.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/KjwQ8mz5/student-cv-template-with-no-experience.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/SN50RtxZ/Resume-Examples-for-Students-First-Job.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/8zMvscSj/resume-example-with-no-experience.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/XqkpbHBL/Crafting-a-Sample-Resume-for-Students-with-No-Work-Experience.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/WpxXWFZ8/freepik-an-asian-man-25-years-old-black-hair-wearing-glass-31571.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/J0Y0Pwnd/teenager-resume-1.webp',
      alt: "Teenager Resume",
    },
    {
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/7P1w02Gp/Teenager-Resume-Template.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/1gFGw9Hq/Teenager-Resume-with-No-Work-Experience-2.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/g0kgB8jx/Teenager-Resume-with-No-Work-Experience1.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/bwWFqDWC/Resume-Format.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/05KZYbg1/Attention-Grabbing-Resume-Summary.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/P5vzd6mZ/multi-page-resume-formatting.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/xTLNrmr3/High-School-Teenager-Resume.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/T3Mt7HMq/cv-summary-for-fresher.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/fLqvs83L/freepik-create-a-colorful-flatstyle-illustration-of-a-prof-45077.webp',
    ...
    },
    {
      ...
      title: "Profile Summary for Freshers 2025: How to Write, Examples, and Free Templates",
      src: 'https://i.postimg.cc/rshDHppR/professional-summary-in-resume-for-fresher.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/7hZH0VdJ/Resume-for-AI-Driven-Hiring-Systems.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/d0hdxfS8/enhace-cv-visibility.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/jjLjZmqy/recent-graduate-cover-letter.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/mDP5Y48P/hr-manager-cover-letter.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/pLWLV51P/short-cover-letter-for-costumer-services.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/kgXyv7Mn/resume-vs-cover-letter.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/T2qLBKfq/Civil-Engineering-Resume-for-Freshers.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/wjR7Qpcn/Electrician-Resume-pdf.webp',
    ...
    },
    {
      ...
      src: 'https://i.postimg.cc/NjmBP196/Automation-Testing-Resume.webp',
    ...
    },
    {
      ...
      title: "Marriage Biodata Format: Free Download Now | Edit and Guide",
      src: 'https://i.postimg.cc/j2jjRGKS/marriage-biodata-image.webp',
      alt: "Marriage Biodata Format: Free Download Now | Edit and Guide",
    },
    {
      path: "/muslim-biodata-for-marriage",
      title: "Muslim Biodata for Marriage: A Comprehensive Guide",
      src: 'https://i.postimg.cc/j2jjRGKS/marriage-biodata-image.webp',
      alt: "Muslim Biodata for Marriage",
    },
    {
      path: "/muslim-marriage-biodata-format",
      title: "Muslim Marriage Biodata Format: A Comprehensive Guide",
      src: 'https://i.postimg.cc/j2jjRGKS/marriage-biodata-image.webp',
...
export default memo(ImportantPostLink);
