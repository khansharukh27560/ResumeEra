      ...
      <div className="main304 marging">
        ...
        >
          <div className="personalInfo304" style={{ backgroundColor: bgColor, padding: `${padding}px` }}>
            ...
            {Array.isArray(socialMediaLink?.[0]) && socialMediaLink[0].length > 0 && (
                <div

                >
                  {socialMediaLink[0].map((item) => (
                    <ul key={item.type}className='d-flex' style={{flexDirection:'column',justifyContent:'end',alignItems:'end'}}>
