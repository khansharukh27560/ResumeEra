...
import Border_Fashion_married from '../../../image/shadi biodata/Muslim merrieage biodata/GoldenArchWithBlue.webp'
...
export default function Preview504() {
    ...
    const [lineSpacing, setLineSpacing] = useState('0.5'); // Line spacing for text
    const [sectionSpacing, setSectionSpacing] = useState('1'); // Spacing between sections
    const data = useSelector((state) => {
        const reduxData = state.reducer.shadiData[0];
        return reduxData ? reduxData : JSON.parse(localStorage.getItem('personalInfo'));
      });
      const lordImage = useSelector((state) => state.reducer.selectedIcon[0]);
    console.info('result1 in preview507:-', lordImage)
    useEffect(() => {
            ...
            <div className='d-md-flex justify-content-between'>
                <div class=" preview401 inner-content"
                    style={{
                        ...
                        fontFamily:fontStyle,lineHeight: lineSpacing,
                        color: fontColor,
                    ...
                    >
                        <div className=''>
                           <div className='lordImage'>
                                    <img src={lordImage} alt="loard-Image"  />
                                    </div>
                            <div className="personal-info401 d-flex justify-content-between" style={{lineHeight:sectionSpacing}}>
                                <div>
                                    <h3 style={{ color: headingColor, fontSize: `${headingSize}px`,lineHeight: lineSpacing,fontFamily:fontStyle}}>
                                        Personal Details
                                    </h3>
