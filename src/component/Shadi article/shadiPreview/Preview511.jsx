...
import Border_Fashion_married from '../../../image/shadi biodata/Muslim merrieage biodata/LightBlueFlowerShadiCard.webp'

export default function Preview501() {
                    ...
                    >
                        ...
                        <div className='lordImage'>
                            ...
                            <div className="personal-info401 d-flex justify-content-between">
                                <div>
                                    <h3 style={{ color: headingColor, fontSize: `${headingSize}px`,fontFamily:fontStyle }}>
                                        Personal Details
                                    </h3>
