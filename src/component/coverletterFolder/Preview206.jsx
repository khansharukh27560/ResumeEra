...
export default function Preview206() {
    ...
    return (
        <div className="  justify-content-between marging" style={{flexDirection:'column'}}>
            ...
            spellCheck={true}
                ...
                <div className='header205'>
                    ...
                    <div className="right205 d-flex justify-content-around align-items-center" style={{backgroundColor:'#212b33'}}>
                        <p className='text-end ' style={dynamicStyle}>{result.email} <span className="icon" style={dynamicStyle} >✉️</span></p>
                        <p className='text-end' style={dynamicStyle}>{result.mobileNumber} <span className="icon" style={dynamicStyle} >📞</span></p>
                        <p className='text-end' style={dynamicStyle}>{result.city}, {result.state || "CA"} <span className="icon" style={dynamicStyle} >📍</span></p>
                        <p className='text-end' style={dynamicStyle}>{result.linkedin} <span className="icon" style={dynamicStyle}>🔗</span></p>
                    </div>
                </div>
